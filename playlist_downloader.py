...
class audio:
    def __init__ (self,url,count):
        ...
        self.audiostreams = self.video.videostreams
        self.download_url =  self.audiostreams[-1].url
...
if __name__== "__main__":
    ...
    query = 'https://www.youtube.com/playlist?list=PLSPWNkAMSvv5DKeSVDbEbUKSsK4Z-GgiP'
    try:
